      ...
      <main className={styles.main}>
        <nav className="navbar mt-4 mb-4">
          <div className="container">
            ...
            <div className="navbar-end" style={{textAlign:"center"}}>
        ...
        <div className="container">
          <section className="mt-5">
            <div className="columns">
              <div className="column is-two-thirds" style={{textAlign:"center"}}>
                <section className="mt-5">
                  <p>Enter the lottery by sending 10 HACT</p>
